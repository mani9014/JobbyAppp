...
class AboutJobItem extends Component{
    ...
    getjobData = async props => {
        ...
        const jwtToken = Cookis.get('jwt_token')
        ...
        if(responseJobData.ok === true){
            ...
            const updatedJobDetailsData = [fetchedJobData.job_details].map(eachItem => ({
                ...
                employmentType: eachItem.employement_type,
                id: eachItem.id,
                        ...
                        <ul className="ul-job-details-container">
                            {skills.map(eachItem => (
                                <li className="li-job-details-container" key ={eachItem.name}>
                                    <img src={eachItem.imageUrl} className="skill-img" alt={eachItem.name} />
                                    <p>{eachItem.name}</p>
                                </li>
                            ))}
                        </ul>
    ...
    renderJobFailureView = () => (
        <div className="job-details-failure-view">
            ...
            <p>we cannot seem to find the page you are loading for.</p>
            <div className="btn-container-failure">
                <button className="failure-job-details-btn" type="button" onClick={this.onRetryJobDetailsAgain}>
                    retry
                </button>
            </div>
        </div>
